/**
 * Weather Service for AgriShield X
 * Uses Open-Meteo free API for live agricultural weather & risk metrics.
 * Gracefully falls back to structured demo weather if offline/unavailable.
 */
...
export const getWeatherForecast = async (lat = 12.9716, lon = 77.5946) => {
  try {
    ...
    console.warn('[AgriShield Weather] Open-Meteo API unreachable, using demo weather fallback:', err.message);
  }
